...
public class ExceptionHTTPCodesTest {
    ...
    static Stream<Arguments> params() {
        return Stream.of(
                ...
                Arguments.of(ResultCode.INVALID_NAMESPACE, HttpStatus.NOT_FOUND),
                ...
                Arguments.of(ResultCode.BATCH_MAX_REQUESTS_EXCEEDED, HttpStatus.BAD_REQUEST),
                ...
                Arguments.of(ResultCode.BATCH_QUEUES_FULL, HttpStatus.INTERNAL_SERVER_ERROR),
                Arguments.of(ResultCode.BATCH_FAILED, HttpStatus.INTERNAL_SERVER_ERROR)
        );
    }

    @ParameterizedTest
    @MethodSource("params")
    public void correctStatusCodeTest(int exceptionCode, HttpStatus expectedStatus) {
        AerospikeException testException = new AerospikeException(exceptionCode);
        ResponseEntity<Object> retEntity = handler.handleAsError(testException);
        Assertions.assertEquals(expectedStatus, retEntity.getStatusCode());
    }
